...
import { WHATSAPP_EMAIL, WHATSAPP_NUMBER } from "@/data/fincas";
    ...
    <footer className="bg-green-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <h3 className="font-bold text-xl mb-3">Mundo Fincas</h3>
            <p className="text-green-300 text-sm leading-relaxed">
              Alquiler de fincas en el Occidente Antioqueño. Tu descanso,
              nuestra pasión.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-green-300">
              ...
              >
                <span>📱</span> +57 311 372 6248
              </a>
              <a
                href={`mailto:${WHATSAPP_EMAIL}`}
                className="hover:text-white transition-colors flex items-center gap-2"
              >
                <span>✉️</span> {WHATSAPP_EMAIL}
              </a>
              <p className="flex items-center gap-2">
                <span>📍</span> Occidente Antioqueño, Colombia
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-green-800 mt-10 pt-6 text-center text-green-400 text-sm">
          <p>
            © {new Date().getFullYear()} Mundo Fincas. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
